...
var ReactMic = function (_Component) {
  ...
  ReactMic.prototype.componentDidMount = function componentDidMount() {
    ...
    if (audioElem) {
      ...
      this.setState({
        analyser: _analyser,
        microphoneRecorder: new _MicrophoneRecorder.MicrophoneRecorder(onStart, onStop, onSave, onData, onDataPcm, options),
        canvas: canvas,
        canvasCtx: canvasCtx
      }, function () {
        _this2.visualize();
